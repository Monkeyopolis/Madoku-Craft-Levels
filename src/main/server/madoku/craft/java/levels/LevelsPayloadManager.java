...
public final class LevelsPayloadManager {
	...
	public static void initialize() {
		PayloadTypeRegistry.clientboundPlay().register(LevelsPayloadAPIManager.Payload.TYPE, LevelsPayloadAPIManager.Payload.CODEC);
		PayloadTypeRegistry.serverboundPlay().register(LevelsPayloadAPIManager.LevelUpPayload.TYPE, LevelsPayloadAPIManager.LevelUpPayload.CODEC);
